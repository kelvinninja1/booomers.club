...
$memberStats = array();
$memberStats['total'] = DB::count("SELECT * FROM `users_tb` WHERE 1");
$memberStats['active'] = DB::count("SELECT * FROM `status_tb` WHERE `account` = 'active'");
$memberStats['inactive'] = DB::count("SELECT * FROM `status_tb` WHERE `account` = 'inactive'");
$memberStats['banned'] = DB::count("SELECT * FROM `status_tb` WHERE `account` = 'banned'");



$dbUsers = DB::query('SELECT * FROM `users_tb` WHERE 1 order by id desc');
