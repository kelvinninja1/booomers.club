...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Settlements</h1>
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            ...
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$fundStats['total']?> (<?=$fundStats['totalTotal']?>)</div>
          </div>
          <div class="col-auto">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            ...
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$fundStats['proccessed']?> (<?=$fundStats['proccessedTotal']?>)</div>
          </div>
          <div class="col-auto">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            ...
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$fundStats['active']?> (<?=$fundStats['activeTotal']?>)</div>
          </div>
          <div class="col-auto">
  ...
  <div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-warning shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Unsettled (Requests)</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$fundStats['unsettled']?> (<?=$fundStats['unsettledTotal']?>)</div>
          </div>
          <div class="col-auto">
  ...
  <div class="col-xl-12 col-lg-12">
    ...
    <!-- <div class="card shadow mb-4"> -->
      ...
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Settlements</h6>
...
$fundAmount = $row['set_total'];
$fundRef = doSettlementMaths($fundAmount);
$fundPlan = $fundRef['rate']."% [".$fundRef['cycles']." Cycles]";
$fundWallet = $row['username'];
$fundDate = '<span class="text-primary">'.$row['set_date'].'</span> - <span class="text-danger">'.$row['last_date'].'</span>';
$id= $row['dir'];
